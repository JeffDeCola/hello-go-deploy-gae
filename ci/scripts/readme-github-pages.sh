#!/bin/sh
# hello-go-deploy-gae readme-github-pages.sh
...
echo "The goal is to git clone /hello-go-deploy-gae to /hello-go-deploy-gae-updated"
...
echo "   /hello-go-deploy-gae-updated (created in task-build-push.yml task file)"
echo " "
...
echo "git clone hello-go-deploy-gae to hello-go-deploy-gae-updated"
git clone hello-go-deploy-gae hello-go-deploy-gae-updated
echo " "

echo "cd hello-go-deploy-gae-updated"
cd hello-go-deploy-gae-updated
echo " "
...
echo "    sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/hello-go-deploy-gae\/master\/svgs\//g' temp-README.md"
sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/hello-go-deploy-gae\/master\/svgs\//g' temp-README.md
echo " "
