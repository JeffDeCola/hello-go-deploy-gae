...
echo "cp -r hello-go-deploy-gae/hello-go-deploy-gae-code/* dist"
cp -r hello-go-deploy-gae/hello-go-deploy-gae-code/* dist
echo " "
...
#echo "cd src/github.com/JeffDeCola/hello-go-deploy-gae/hello-go-deploy-gae-code"
#cd src/github.com/JeffDeCola/hello-go-deploy-gae/hello-go-deploy-gae-code
#echo " "
...
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-gae/hello-go-deploy-gae-code/bin/hello-go" .
#echo " "

#echo "cp the Dockerfile into /dist"
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-gae/hello-go-deploy-gae-code/build-push/Dockerfile" .
#echo " "
