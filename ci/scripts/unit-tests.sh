#!/bin/sh
# hello-go-deploy-gae unit-tests.sh
...
echo "The goal is to set up a go src/github.com/JeffDeCola/hello-go-deploy-gae directory"
...
echo "cp -R ./hello-go-deploy-gae src/github.com/JeffDeCola/."
...
# echo "mkdir -p test"
# mkdir -p test
# echo "Placeholder to run go tests for hello-go-deploy-gae" | tee test/test_coverage.txt
# echo " "
