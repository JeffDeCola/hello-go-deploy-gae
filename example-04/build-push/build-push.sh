...
docker build -f build-push/Dockerfile -t jeffdecola/hello-go-deploy-gae .
echo " "
...
echo "     docker run -p 8080:8080 --name hello-go-deploy-gae -dit jeffdecola/hello-go-deploy-gae"
